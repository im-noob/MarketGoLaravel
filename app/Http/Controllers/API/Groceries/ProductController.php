...
class ProductController extends Controller
{
    ...
    public function ShopSearchData(Request $request){
    	...
    	$data = DB::table('gro_map_tab')
				...
				->select("gro_cat_tab.gro_cat_id","gro_cat_tab.gro_cat_name","gro_subcat_tab.gro_subcat_id","gro_subcat_tab.subcat_name","gro_menufacture_tab.menu_name","gro_product_list_tab.*","gro_map_tab.gro_map_id")
				->whereIn('gro_map_id',$mapId)
				->where('gro_product_list_tab.gro_product_name','like','%'.$search.'%')
				->skip(0)->take(50)
				->get();
    ...
    public function getRestProductList(Request $request){
    	...
    	$data = DB::table('gro_map_tab')
				...
				->select("gro_cat_tab.gro_cat_id","gro_cat_tab.gro_cat_name","gro_subcat_tab.gro_subcat_id","gro_subcat_tab.subcat_name","gro_menufacture_tab.menu_name","gro_map_tab.unit_id","gro_product_list_tab.*","gro_map_tab.gro_map_id","gro_map_tab.price","gro_map_tab.quantity","unit_tab.unit_name")
				->whereNotIn('gro_map_id',$mapId)
				->inRandomOrder()
				->skip(0)->take(100)
				->get();
